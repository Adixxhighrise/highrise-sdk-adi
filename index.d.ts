 ...
 * @example
 * const { Highrise, Events } = require("highrise-sdk-adi");
 ...
 */
   ...
   * 
   * @example
   * const { Highrise } = require("highrise-sdk-adi");
...
export class Outfit {
  ...
  */
   ...
   * 
   * @example
   * const { Highrise, BodyParts } = require("highrise-sdk-adi");
   * const bot = new Highrise();
   * 
   * // Change the color of a body part.
  ...
  */
  ...
  boost: {
    ...
    */
     ...
     * 
     * @example
     * const { Highrise, Prioreties } = require("highrise-sdk-adi");
     * const bot = new Highrise();
     * 
...
export class Move {
   ...
   * 
   * @example
   * const { Highrise, Facing } = require("highrise-sdk-adi");
   * const bot = new Highrise();
   * 
...
export class Users {
   ...
   * 
   * @example
   * const { Highrise, Emotes } = require("highrise-sdk-adi");
   * const bot = new Highrise();
   * 
  ...
  */
   ...
   * 
   * @example
   * const { Highrise, Reactions } = require("highrise-sdk-adi");
   * const bot = new Highrise();
   * 
  ...
  */
   ...
   * 
   * @example
   * const { Highrise, GoldBars } = require("highrise-sdk-adi");
   * const bot = new Highrise();
   * 
...
export const WebApi = new class {
  ...
  * 
  * @example
  * const { WebApi } = require("highrise-sdk-adi");
